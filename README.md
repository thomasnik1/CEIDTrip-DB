...
## Docker commands
Use sudo docker compose up -d to build the container. The database will already be initialized.
Use sudo docker exec -it ceidtrip-db mysql -u root -p to enter container in mysql cli.
